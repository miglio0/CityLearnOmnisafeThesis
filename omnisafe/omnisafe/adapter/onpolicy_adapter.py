                ...
                if epoch_end or done or time_out:
                    ...
                    if done or time_out:
                        ...
                        if self._env_id == 'CityLearn-v0':
                            logger.store(
                                {
                                    'Metrics/Discomfort': info['final_info']['discomfort'],
                                    'Metrics/CO2_Emissions': info['final_info']['carbon_emissions'],
                                    'Metrics/Electricity_Consumption': info['final_info']['net_consumption'],
                                }
                            )
